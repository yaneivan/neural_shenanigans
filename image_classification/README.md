Мне нужно было разделить исходный датасет на два датасета. В одном были бы только картинки с текстом написанным прописью, а в другом только напечатанные на принтере. 
